...
| OW-014 | תיקון באג = בדיקת-רגרסיה באותו PR (נכשלת-לפני/עוברת-אחרי) + טסטים הרמטיים | [[OW.md]] |
| OW-015 | בדיקה שעוברת ≠ כיסוי — ספור את המשטח (N/M) לפני שמדווחים "תקין"; גלאי משקר גרוע מאין | [[OW.md]] |
| OW-016 | הכלל, אל תטלא — באג ספציפי → הגדר מחלקה → בנה גלאי (הוכח דו-כיווני) → חווט ללולאה הרציפה | [[OW.md]] |
