...
### OW-016 | הכלל, אל תטלא — כל באג ספציפי הופך למחלקה שהמערכת תופסת לבד
**מקור:** מייסד, 2026-07-24/25 — אחרי שהצביע ידנית על חלון-פריט תקוע, toast שחור-על-שחור, ואז כפתור "Show Results" שחור-על-שחור: "אתה שוב מתעסק בבעיה ספציפית. אני רוצה שיהיה לך את הבעיה הזאת כפרפרנס לאיך להסתכל בכללי על בעיות... ואז כל הזמן תוכל לרוץ ולשפר." וגם: "למה הייתי צריך להגיד לך... בפועל אני רוצה שתדע להבין לבד ואז גם תתקן." תיקון-האינסטנס הוא מתחת לרף.
**לקח:** המטרה היא מערכת שמוצאת ומתקנת את הפגמים של עצמה ולא חוזרת על טעות. תיקון חד-פעמי משאיר את המחלקה חיה ומשאיר את המייסד כ-QA — ההפך מהמטרה. השאלה הראשונה על כל באג (וכל רעיון-שיפור) היא "איך המערכת הייתה תופסת את זה לבד?".
**מנגנון — 5 צעדים, לא לעצור אחרי 1:** (1) תקן את האינסטנס. (2) **הגדר את המחלקה** (למשל "overlay עם `position:absolute` נשבר בגלילה"; "צבע-טקסט == צבע-רקע בכל מקום, כולל בתוך overlays"). (3) בנה/הרחב **גלאי דטרמיניסטי** למחלקה, והוכח אותו **דו-כיוונית** (עובר על קוד תקין, תופס רגרסיה מוזרקת — [[OW-015]]). (4) **חווט את הגלאי ללולאה הרציפה**: `scripts/defect_scan.py` → `ci-debug/DEFECTS.md` → הסוכנים בוחרים את הפגם הגבוה כל מחזור. אם ה-parser לא רואה את הפלט החדש של הגלאי — ה-parser הוא הבאג האמיתי. (5) עגן כ-OW code שכל הסוכנים יורשים. אחות של [[OW-014]] (רגרסיה באותו PR) ו-[[OW-015]] (ספירת-משטח).
