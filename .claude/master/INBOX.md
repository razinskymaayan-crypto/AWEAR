...
## משימות חדשות
תעשו סקר משתמשים על הסטטיסטיקה של הארון (closet statistics / analytics) — פאנל מומחים, גרפים ונקודות סיכום לטלגרם, ותקנו מה שצריך.
אני רוצה שתעבדו על הinsight בחנות שלי, תבינו מה צריך להוסיף מה אדם שיש לו חנות ירצה לראות, שזה לא יהיה אחד לאחד מה שיש בשורת סטטיסטיקות למעלה אני רוצה שזה יעזור לאנשים להבין איך להשתמש יותר טוב בחנות שלהם
