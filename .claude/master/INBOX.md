...
בנו את מסך ה-WOW: בכניסה לפריט מתוך פוסט בפיד יוצג (א) אחוז התאמה בולט לארון שלי, (ב) 2-3 לוקים שה-AI הרכיב משילוב הפריט עם בגדים שכבר קיימים בארון שלי, (ג) "איך הוא נמכר" עם כפתור קנייה למקור. זה הלב של הדמו — תעדפו מעל הכל, ואפשר לפרק לכמה ריצות (קודם אחוז ההתאמה, אז הלוקים מהארון, אז הקנייה).
