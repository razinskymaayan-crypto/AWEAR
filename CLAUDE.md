...
3. Check `.claude/agents/activity_log.md` last 5 entries for concurrent edits; append your own when done: `| YYYY-MM-DD | agent | branch/file | status | description |`
...
- Pipeline/automation docs: `.claude/agents/docs/PIPELINE.md` · Telegram only via `scripts/tglib.py`
