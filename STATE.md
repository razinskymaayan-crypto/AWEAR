...
## Mark lane — last run (2026-08-08, run 67)
- **Task**: Animate look-sheet match% chip 0→target on open — same easeOutCubic 600ms as item-detail ring. Commit 5a3f177.
- **Done**: static/app.js only. node --check green. check-render green. DS-004 clean (no new hex).
