// ---- i18n: locale + strings, loaded synchronously BEFORE any render function runs ----
  ...
  let SEED_POSTS=[
    ...
    {id:'s28',userId:'u2',user:'carmel', name:'Carmel',verified:false,caption:'Summer heat minimal fit',    tags:['minimal','street','summer'],  price:244,look_total_usd:244,img:'/static/img/users/carmel/look2.jpg',grad:'linear-gradient(160deg,#e0c3fc,#8ec5fc)',        likes:2800,trend:88,earn:24,mtags:['minimal','street','summer','bottoms','shoes'],items:[{category:'top',name:'Gray sleeveless tee',price_estimate_usd:35,q:'gray muscle tank top men'},{category:'bottoms',name:'White pinstripe trousers',price_estimate_usd:89,q:'white pinstripe straight leg trousers'},{category:'shoes',name:'Birkenstock Arizona',price_estimate_usd:120,q:'birkenstock arizona sandals beige'}]},
    {id:'s29',userId:'u1',user:'tamar',  name:'Tamar', verified:true, caption:'Cozy layers done right',     tags:['casual','minimal','cozy'],    price:188,look_total_usd:188,img:'/static/img/users/tamar/look3.jpg', grad:'linear-gradient(160deg,#2d2d2d,#6a6a6a)',        likes:2200,trend:86,earn:19,mtags:['casual','minimal','cozy','top','bottoms'],   items:[{category:'top',name:'Black star hoodie',price_estimate_usd:89,q:'black oversized hoodie women'},{category:'bottoms',name:'Light wash wide-leg jeans',price_estimate_usd:99,q:'light wash wide leg jeans women'}]},
    {id:'s30',userId:'u3',user:'maayan', name:'Maayan',verified:true, caption:'Store fit check',             tags:['minimal','clean','summer'],   price:120,look_total_usd:120,img:'/static/img/users/maayan/look2.jpg',grad:'linear-gradient(160deg,#1e3c72,#2a5298)',        likes:1600,trend:83,earn:12,mtags:['minimal','clean','summer','top','bottoms'],   items:[{category:'top',name:'Navy polo shirt',price_estimate_usd:55,q:'navy polo shirt men minimal'},{category:'bottoms',name:'Light gray chino shorts',price_estimate_usd:65,q:'gray chino shorts men'}]},
  ];
