// ---- i18n: locale + strings, loaded synchronously BEFORE any render function runs ----
    ...
    body.innerHTML=_scItems.map((si,idx)=>{
      ...
      return `<div class="sc-card${si.accepted?'':' sc-rejected'}" id="sc-card-${idx}">
        ...
        <div class="sc-source-wrap">
          <label class="sc-source-label" for="sc-src-${idx}">${icon('link',13)} Product link <span class="sc-source-badge">${icon('zap',9)} Earn tokens</span></label>
          <input id="sc-src-${idx}" class="sc-field sc-source-field${urlValid?' sc-field--valid':it.source_url?' sc-field--warn':''}" value="${attr(it.source_url)}" placeholder="https://store.com/product-page" type="url" autocomplete="url" oninput="scUpdateField(${idx},'source_url',this.value);_scUrlFeedback(this)">
          <div class="sc-source-hint">${icon('zap',10)} Paste the exact product URL — makes this item shoppable and earns you creator tokens every time someone buys through your post</div>
        </div>
  ...
  // ---- Feed ----
  let SEED_POSTS=[
    {id:'s1',userId:'u1',user:'tamar', name:'Tamar',verified:true, caption:'Yellow halter & baggy denim',      tags:['y2k','casual','minimal'],   price:149,look_total_usd:149,img:'/static/img/users/tamar/look1.jpg',grad:'linear-gradient(160deg,#ff9a8b,#ff6a88,#ff99ac)',likes:2400,trend:91,earn:15,mtags:['y2k','casual','minimal','top','dress'],items:[{category:'top',name:'White cropped tee',price_estimate_usd:79,q:'white cropped tee',source_url:'https://www.asos.com/search/?q=white+cropped+tee'},{category:'bottoms',name:'Beige baker trousers',price_estimate_usd:159,q:'beige baker trousers',source_url:'https://www.asos.com/search/?q=beige+baker+trousers'},{category:'shoes',name:'White sneakers',price_estimate_usd:220,q:'white leather sneakers',source_url:'https://www.asos.com/search/?q=white+leather+sneakers'},{category:'accessory',name:'Sunglasses',price_estimate_usd:89,q:'trendy sunglasses',source_url:'https://www.asos.com/search/?q=trendy+sunglasses'}]},
    {id:'s2',userId:'u2',user:'carmel', name:'Carmel', verified:false,caption:'Street casual fit',           tags:['streetwear','utility'],      price:219,look_total_usd:219,img:'/static/img/users/carmel/look1.jpg',grad:'linear-gradient(160deg,#a18cd1,#fbc2eb)',         likes:5100,trend:96,earn:22,mtags:['streetwear','utility','bottoms','sneakers','shoes'],items:[{category:'top',name:'Oversized tee',price_estimate_usd:99,q:'oversized graphic tee',source_url:'https://www.asos.com/search/?q=oversized+graphic+tee'},{category:'bottoms',name:'Parachute cargos',price_estimate_usd:159,q:'parachute cargo pants',source_url:'https://www.asos.com/search/?q=parachute+cargo+pants'},{category:'shoes',name:'Adidas Samba',price_estimate_usd:449,q:'adidas samba',source_url:'https://www.asos.com/adidas/adidas-samba/'},{category:'accessory',name:'Baseball cap',price_estimate_usd:69,q:'baseball cap',source_url:'https://www.asos.com/search/?q=baseball+cap'}]},
    {id:'s3',userId:'u3',user:'maayan',name:'Maayan',verified:true, caption:'Minimal menswear',     tags:['secondhand','vintage'],      price:89,look_total_usd:89, img:'/static/img/users/maayan/look1.jpg',                 grad:'linear-gradient(160deg,#84fab0,#8fd3f4)',         likes:1800,trend:82,earn:9, mtags:['secondhand','vintage','everyday','top','bag'],items:[{category:'top',name:'Vintage shirt',price_estimate_usd:45,q:'vintage shirt',source_url:'https://www.asos.com/search/?q=vintage+shirt+men'},{category:'bottoms',name:'Mom jeans',price_estimate_usd:89,q:'vintage mom jeans',source_url:'https://www.asos.com/search/?q=vintage+mom+jeans'},{category:'bag',name:'Shoulder bag',price_estimate_usd:60,q:'vintage shoulder bag',source_url:'https://www.asos.com/search/?q=vintage+shoulder+bag'}]},
    {id:'s4',userId:'u4',user:'shir.daily', name:'Shir', verified:false,caption:'Sunday outfit',        tags:['minimal','ootd'],            price:179,look_total_usd:179,img:'/static/img/users/carmel/look3.jpg',                 grad:'linear-gradient(160deg,#fccb90,#d57eeb)',         likes:3300,trend:88,earn:18,mtags:['minimal','everyday','ootd','dress','shoes'],items:[{category:'dress',name:'Midi dress',price_estimate_usd:179,q:'midi slip dress'},{category:'shoes',name:'Ballet flats',price_estimate_usd:120,q:'ballet flats'},{category:'bag',name:'Mini bag',price_estimate_usd:95,q:'mini bag'}]},
    {id:'s5',userId:'u5',user:'agam.x',     name:'Agam', verified:true, caption:'Vintage vibes',            tags:['vintage','retro'],           price:259,look_total_usd:259,img:'/static/img/users/carmel/look4.jpg',                 grad:'linear-gradient(160deg,#5ee7df,#b490ca)',         likes:4000,trend:94,earn:26,mtags:['vintage','retro','thrifted','accessory','outerwear'],items:[{category:'outerwear',name:'Denim jacket',price_estimate_usd:199,q:'vintage denim jacket'},{category:'accessory',name:'Retro sunglasses',price_estimate_usd:79,q:'retro sunglasses'},{category:'shoes',name:'Cowboy boots',price_estimate_usd:259,q:'cowboy boots'}]},
    {id:'s6',userId:'u6',user:'dana.edit',  name:'Dana', verified:false,caption:'Office but make it cute',  tags:['minimal','ootd'],            price:320,look_total_usd:320,img:'/static/img/users/carmel/look5.jpg',                 grad:'linear-gradient(160deg,#f8ceec,#a29bfe)',         likes:6200,trend:97,earn:32,mtags:['minimal','business','dress','shoes','bag'],items:[{category:'dress',name:'Blazer dress',price_estimate_usd:320,q:'blazer dress'},{category:'shoes',name:'Loafers',price_estimate_usd:199,q:'leather loafers'},{category:'bag',name:'Structured bag',price_estimate_usd:240,q:'structured work bag'}]},
    {id:'s7',userId:'u1',user:'tamar',name:'Tamar', verified:true, caption:'Elevator mirror moment',           tags:['casual','y2k'],              price:120,look_total_usd:120,img:'/static/img/users/tamar/look2.jpg',                 grad:'linear-gradient(160deg,#89f7fe,#66a6ff)',         likes:3800,trend:89,earn:12,mtags:['casual','summer','y2k','top','bottoms'],items:[{category:'top',name:'Bikini top',price_estimate_usd:69,q:'bikini top',source_url:'https://www.asos.com/search/?q=bikini+top'},{category:'bottoms',name:'Linen pants',price_estimate_usd:120,q:'linen beach pants',source_url:'https://www.asos.com/search/?q=linen+beach+pants'},{category:'accessory',name:'Straw hat',price_estimate_usd:79,q:'straw hat',source_url:'https://www.asos.com/search/?q=straw+hat'}]},
    {id:'s8',user:'emma.edit',  name:'Emma',verified:true, caption:'Business casual done right',   tags:['minimal','ootd','business'], price:340,look_total_usd:340,img:'/static/img/users/carmel/look6.jpg',                 grad:'linear-gradient(160deg,#89f7fe,#66a6ff)',         likes:4100,trend:93,earn:20,mtags:['business','minimal','dress','shoes'],items:[{category:'dress',name:'Blazer dress',price_estimate_usd:280,q:'blazer dress work'},{category:'shoes',name:'Pointed toe heels',price_estimate_usd:199,q:'pointed toe heels beige'},{category:'bag',name:'Croc tote',price_estimate_usd:320,q:'croc leather tote bag'}]},
    {id:'s9',user:'zara.fits',  name:'Zara', verified:false,caption:'Quiet luxury era',            tags:['minimal','luxury'],          price:580,look_total_usd:580,img:'/static/img/users/carmel/look7.jpg',                 grad:'linear-gradient(160deg,#e0c3fc,#8ec5fc)',         likes:7200,trend:98,earn:36,mtags:['minimal','luxury','outerwear','shoes'],items:[{category:'outerwear',name:'Camel wool coat',price_estimate_usd:580,q:'camel cashmere coat'},{category:'bottoms',name:'Wide leg trousers',price_estimate_usd:220,q:'tailored wide leg trousers cream'},{category:'shoes',name:'Ballet flats',price_estimate_usd:180,q:'satin ballet flats beige'}]},
    {id:'s10',user:'sport.mia', name:'Mia', verified:false,caption:'Gym to brunch vibes',          tags:['athleisure','casual'],       price:180,look_total_usd:180,img:'/static/img/users/carmel/look8.jpg',                 grad:'linear-gradient(160deg,#43e97b,#38f9d7)',         likes:2900,trend:85,earn:14,mtags:['athleisure','sport','casual'],items:[{category:'top',name:'Sports bra',price_estimate_usd:78,q:'sports bra lululemon'},{category:'bottoms',name:'Flare leggings',price_estimate_usd:128,q:'flare yoga leggings'},{category:'outerwear',name:'Cropped hoodie',price_estimate_usd:89,q:'cropped zip hoodie'}]},
    {id:'s11',user:'thrift.ada',name:'Ada', verified:true, caption:'$40 thrift haul total',        tags:['vintage','secondhand'],      price:40,look_total_usd:40, img:'/static/img/users/carmel/look9.jpg',                 grad:'linear-gradient(160deg,#fddb92,#d1fdff)',         likes:5500,trend:95,earn:27,mtags:['vintage','thrifted','secondhand'],items:[{category:'top',name:'90s band tee',price_estimate_usd:12,q:'vintage band tee'},{category:'bottoms',name:'High waist denim',price_estimate_usd:18,q:'vintage high waist jeans'},{category:'shoes',name:'Platform sandals',price_estimate_usd:9,q:'platform sandals thrift'}]},
    {id:'s12',user:'boho.sara', name:'Sara', verified:false,caption:'Festival ready',              tags:['vintage','casual','boho'],   price:195,look_total_usd:195,img:'/static/img/users/carmel/look10.jpg',                 grad:'linear-gradient(160deg,#f093fb,#f5576c)',         likes:3200,trend:87,earn:16,mtags:['boho','vintage','festival'],items:[{category:'top',name:'Crochet top',price_estimate_usd:65,q:'crochet top boho'},{category:'bottoms',name:'Maxi skirt',price_estimate_usd:89,q:'flowy maxi skirt floral'},{category:'accessory',name:'Layered necklaces',price_estimate_usd:40,q:'layered gold necklaces'}]},
    {id:'s13',user:'dark.nina', name:'Nina', verified:true, caption:'Dark academia aesthetic',     tags:['minimal','vintage'],         price:275,look_total_usd:275,img:'/static/img/users/carmel/look11.jpg',                 grad:'linear-gradient(160deg,#2d2d2d,#5a5a5a)',         likes:6800,trend:96,earn:34,mtags:['dark','academia','vintage','minimal'],items:[{category:'outerwear',name:'Plaid blazer',price_estimate_usd:180,q:'plaid oversized blazer'},{category:'top',name:'Turtleneck',price_estimate_usd:69,q:'ribbed turtleneck black'},{category:'bottoms',name:'Plaid mini skirt',price_estimate_usd:95,q:'plaid mini skirt brown'}]},
    {id:'s14',user:'glam.iris', name:'Iris', verified:true, caption:'Going out era',               tags:['y2k','casual'],              price:220,look_total_usd:220,img:'/static/img/users/carmel/look12.jpg',                 grad:'linear-gradient(160deg,#f77062,#fe5196)',         likes:4600,trend:92,earn:23,mtags:['y2k','going-out','night'],items:[{category:'top',name:'Sequin crop top',price_estimate_usd:89,q:'sequin crop top'},{category:'bottoms',name:'Mini skirt',price_estimate_usd:69,q:'satin mini skirt'},{category:'shoes',name:'Strappy heels',price_estimate_usd:149,q:'strappy heeled sandals'}]},
    {id:'s15',user:'maya.home', name:'Maya', verified:false,caption:'WFH but make it cute',        tags:['minimal','casual'],          price:140,look_total_usd:140,img:'/static/img/users/carmel/look13.jpg',                 grad:'linear-gradient(160deg,#a1c4fd,#c2e9fb)',         likes:3400,trend:88,earn:17,mtags:['minimal','casual','everyday'],items:[{category:'top',name:'Knit crop',price_estimate_usd:65,q:'knit crop top soft'},{category:'bottoms',name:'Linen shorts',price_estimate_usd:49,q:'linen shorts white'},{category:'accessory',name:'Reading glasses',price_estimate_usd:29,q:'trendy reading glasses'}]},
    {id:'s16',user:'coquette.b',name:'Bella',verified:true, caption:'Coquette everything',         tags:['y2k','casual'],              price:165,look_total_usd:165,img:'/static/img/users/carmel/look14.jpg',                 grad:'linear-gradient(160deg,#ffecd2,#fcb69f)',         likes:8100,trend:99,earn:40,mtags:['coquette','y2k','soft'],items:[{category:'top',name:'Bow crop cardigan',price_estimate_usd:79,q:'bow detail cardigan pink'},{category:'bottoms',name:'Ballet mini',price_estimate_usd:89,q:'ballet core mini skirt'},{category:'accessory',name:'Pearl headband',price_estimate_usd:25,q:'pearl satin headband'}]},
    {id:'s17',user:'fit.leila', name:'Leila',verified:false,caption:'Running my best life',        tags:['athleisure'],                price:210,look_total_usd:210,img:'/static/img/users/carmel/look15.jpg',                 grad:'linear-gradient(160deg,#5ee7df,#b490ca)',         likes:2100,trend:81,earn:10,mtags:['sport','athleisure','running'],items:[{category:'top',name:'Racing tank',price_estimate_usd:55,q:'running tank top'},{category:'bottoms',name:'2-in-1 shorts',price_estimate_usd:65,q:'running shorts built-in liner'},{category:'shoes',name:'Carbon plate racer',price_estimate_usd:190,q:'carbon plate running shoes'}]},
    {id:'s18',user:'work.claire',name:'Claire',verified:true,caption:'Power dressing works',       tags:['minimal','ootd','business'], price:450,look_total_usd:450,img:'/static/img/users/carmel/look16.jpg',                 grad:'linear-gradient(160deg,#667eea,#764ba2)',         likes:5900,trend:94,earn:29,mtags:['business','formal','power'],items:[{category:'outerwear',name:'Structured blazer',price_estimate_usd:280,q:'structured blazer charcoal'},{category:'bottoms',name:'Tailored trousers',price_estimate_usd:165,q:'tailored suit trousers'},{category:'shoes',name:'Block heel pumps',price_estimate_usd:175,q:'block heel pumps black'}]},
    {id:'s19',user:'maxi.rosy', name:'Rosy',verified:false,caption:'Effortless summer',            tags:['casual','vintage'],          price:135,look_total_usd:135,img:'/static/img/users/carmel/look17.jpg',                 grad:'linear-gradient(160deg,#f6d365,#fda085)',         likes:2800,trend:84,earn:14,mtags:['casual','boho','summer'],items:[{category:'dress',name:'Maxi dress',price_estimate_usd:99,q:'floral maxi dress summer'},{category:'shoes',name:'Espadrilles',price_estimate_usd:69,q:'espadrille wedges natural'},{category:'accessory',name:'Raffia bag',price_estimate_usd:55,q:'raffia tote bag summer'}]},
    {id:'s20',user:'luxe.ines', name:'Ines',verified:true, caption:'Investment pieces only',       tags:['minimal','luxury'],          price:1200,look_total_usd:1200,img:'/static/img/users/maayan/look3.jpg',                grad:'linear-gradient(160deg,#d4d4d4,#f5f5f5)',         likes:9400,trend:99,earn:47,mtags:['luxury','minimal','designer'],items:[{category:'bag',name:'Classic flap bag',price_estimate_usd:5200,q:'classic quilted bag black'},{category:'outerwear',name:'Camel coat',price_estimate_usd:1200,q:'designer camel overcoat'},{category:'shoes',name:'Leather loafers',price_estimate_usd:750,q:'designer leather loafers'}]},
    {id:'s21',user:'varsity.kt',name:'Kate',verified:false,caption:'Varsity season is here',       tags:['streetwear','y2k'],          price:185,look_total_usd:185,img:null,                 grad:'linear-gradient(160deg,#f8ceec,#a29bfe)',         likes:3700,trend:90,earn:18,mtags:['streetwear','y2k','preppy'],items:[{category:'outerwear',name:'Letter jacket',price_estimate_usd:189,q:'varsity letter jacket',source_url:'https://www.asos.com/search/?q=varsity+letter+jacket'},{category:'bottoms',name:'Pleated mini',price_estimate_usd:79,q:'pleated mini skirt',source_url:'https://www.asos.com/search/?q=pleated+mini+skirt'},{category:'shoes',name:'Platform loafers',price_estimate_usd:129,q:'chunky platform loafers',source_url:'https://www.asos.com/search/?q=chunky+platform+loafers'}]},
    {id:'s22',user:'eco.freya', name:'Freya',verified:true,caption:'100% secondhand fit',          tags:['vintage','secondhand'],      price:65,look_total_usd:65, img:null,                 grad:'linear-gradient(160deg,#84fab0,#8fd3f4)',         likes:4200,trend:91,earn:21,mtags:['sustainable','secondhand','eco'],items:[{category:'top',name:'Upcycled denim jacket',price_estimate_usd:25,q:'upcycled denim jacket vintage',preloved:true},{category:'dress',name:'Slip dress thrifted',price_estimate_usd:18,q:'silk slip dress thrift',preloved:true},{category:'shoes',name:'Vintage boots',price_estimate_usd:22,q:'vintage ankle boots brown',preloved:true}]},
    {id:'s23',user:'glam.tiff', name:'Tiffany',verified:false,caption:'Met Gala energy every day', tags:['y2k','streetwear'],         price:490,look_total_usd:490,img:null,                 grad:'linear-gradient(160deg,#ff9a8b,#ff6a88,#ff99ac)', likes:6300,trend:97,earn:31,mtags:['maximalist','glam','event'],items:[{category:'dress',name:'Feather trim dress',price_estimate_usd:340,q:'feather trim mini dress',source_url:'https://www.asos.com/search/?q=feather+trim+mini+dress'},{category:'shoes',name:'Platform boots',price_estimate_usd:299,q:'platform knee high boots',source_url:'https://www.asos.com/search/?q=platform+knee+high+boots'},{category:'accessory',name:'Crystal clutch',price_estimate_usd:120,q:'crystal embellished clutch',source_url:'https://www.asos.com/search/?q=crystal+embellished+clutch'}]},
    {id:'s24',user:'soft.jess', name:'Jessica',verified:false,caption:'Everyday softness',         tags:['minimal','casual'],          price:95,look_total_usd:95, img:null,                 grad:'linear-gradient(160deg,#a8edea,#fed6e3)',         likes:1900,trend:80,earn:9, mtags:['minimal','casual','soft'],items:[{category:'top',name:'Bamboo tee',price_estimate_usd:45,q:'bamboo cotton tee neutral',source_url:'https://www.asos.com/search/?q=bamboo+cotton+tee+neutral'},{category:'bottoms',name:'Linen trousers',price_estimate_usd:75,q:'wide leg linen trousers beige',source_url:'https://www.asos.com/search/?q=wide+leg+linen+trousers+beige'},{category:'shoes',name:'Birkenstock Arizona',price_estimate_usd:110,q:'birkenstock arizona sandals',source_url:'https://www.asos.com/search/?q=birkenstock+arizona+sandals'}]},
    {id:'s25',user:'street.kai',name:'Kai',verified:true, caption:'NYC energy no off button',      tags:['streetwear','utility'],      price:280,look_total_usd:280,img:null,                 grad:'linear-gradient(160deg,#2d2d2d,#434343)',         likes:7700,trend:98,earn:38,mtags:['streetwear','utility','nyc'],items:[{category:'outerwear',name:'Tech jacket',price_estimate_usd:320,q:'tech shell jacket black',source_url:'https://www.asos.com/search/?q=tech+shell+jacket+black'},{category:'bottoms',name:'Utility cargos',price_estimate_usd:145,q:'utility cargo pants black',source_url:'https://www.asos.com/search/?q=utility+cargo+pants+black'},{category:'shoes',name:'New Balance 9060',price_estimate_usd:130,q:'new balance 9060 grey',source_url:'https://www.asos.com/search/?q=new+balance+9060+grey'}]},
    {id:'s26',user:'mod.pita',  name:'Pita',verified:false,caption:'Modest fashion is elevated',   tags:['minimal','ootd'],            price:230,look_total_usd:230,img:null,                 grad:'linear-gradient(160deg,#667eea,#764ba2)',         likes:4800,trend:93,earn:24,mtags:['modest','minimal','formal'],items:[{category:'outerwear',name:'Abaya coat',price_estimate_usd:180,q:'longline abaya coat neutral',source_url:'https://www.asos.com/search/?q=longline+abaya+coat+neutral'},{category:'bottoms',name:'Wide palazzo',price_estimate_usd:95,q:'wide leg palazzo trousers',source_url:'https://www.asos.com/search/?q=wide+leg+palazzo+trousers'},{category:'accessory',name:'Silk scarf',price_estimate_usd:89,q:'silk head scarf neutral tones',source_url:'https://www.asos.com/search/?q=silk+head+scarf+neutral+tones'}]},
    {id:'s27',user:'plus.nova', name:'Nova',verified:true, caption:'Curves and confidence',         tags:['casual','y2k'],              price:175,look_total_usd:175,img:null,                 grad:'linear-gradient(160deg,#f8ceec,#a29bfe)',         likes:5100,trend:94,earn:25,mtags:['plus-size','casual','y2k'],items:[{category:'dress',name:'Wrap midi dress',price_estimate_usd:99,q:'wrap midi dress plus size',source_url:'https://www.asos.com/search/?q=wrap+midi+dress+plus+size'},{category:'shoes',name:'Block heels',price_estimate_usd:89,q:'block heel shoes wide fit',source_url:'https://www.asos.com/search/?q=block+heel+shoes+wide+fit'},{category:'accessory',name:'Gold hoops',price_estimate_usd:35,q:'oversized gold hoop earrings',source_url:'https://www.asos.com/search/?q=oversized+gold+hoop+earrings'}]},
    {id:'s28',userId:'u2',user:'carmel', name:'Carmel',verified:false,caption:'Summer heat minimal fit',    tags:['minimal','street','summer'],  price:244,look_total_usd:244,img:'/static/img/users/carmel/look2.jpg',grad:'linear-gradient(160deg,#e0c3fc,#8ec5fc)',        likes:2800,trend:88,earn:24,mtags:['minimal','street','summer','bottoms','shoes'],items:[{category:'top',name:'Gray sleeveless tee',price_estimate_usd:35,q:'gray muscle tank top men',source_url:'https://www.asos.com/search/?q=gray+muscle+tank+top+men'},{category:'bottoms',name:'White pinstripe trousers',price_estimate_usd:89,q:'white pinstripe straight leg trousers',source_url:'https://www.asos.com/search/?q=white+pinstripe+straight+trousers'},{category:'shoes',name:'Birkenstock Arizona',price_estimate_usd:120,q:'birkenstock arizona sandals beige',source_url:'https://www.asos.com/search/?q=birkenstock+arizona+sandals'}]},
    {id:'s29',userId:'u1',user:'tamar',  name:'Tamar', verified:true, caption:'Cozy layers done right',     tags:['casual','minimal','cozy'],    price:188,look_total_usd:188,img:'/static/img/users/tamar/look3.jpg', grad:'linear-gradient(160deg,#2d2d2d,#6a6a6a)',        likes:2200,trend:86,earn:19,mtags:['casual','minimal','cozy','top','bottoms'],   items:[{category:'top',name:'Black star hoodie',price_estimate_usd:89,q:'black oversized hoodie women',source_url:'https://www.asos.com/search/?q=black+oversized+hoodie+women'},{category:'bottoms',name:'Light wash wide-leg jeans',price_estimate_usd:99,q:'light wash wide leg jeans women',source_url:'https://www.asos.com/search/?q=light+wash+wide+leg+jeans'}]},
    {id:'s30',userId:'u3',user:'maayan', name:'Maayan',verified:true, caption:'Store fit check',             tags:['minimal','clean','summer'],   price:120,look_total_usd:120,img:'/static/img/users/maayan/look2.jpg',grad:'linear-gradient(160deg,#1e3c72,#2a5298)',        likes:1600,trend:83,earn:12,mtags:['minimal','clean','summer','top','bottoms'],   items:[{category:'top',name:'Navy polo shirt',price_estimate_usd:55,q:'navy polo shirt men minimal',source_url:'https://www.asos.com/search/?q=navy+polo+shirt+men'},{category:'bottoms',name:'Light gray chino shorts',price_estimate_usd:65,q:'gray chino shorts men',source_url:'https://www.asos.com/search/?q=gray+chino+shorts+men'}]},
  ];
      ...
      if (!loadFeedPosts().length) {
        ...
        saveFeedPosts([
          {ts:now-4*86400000, id:'demo_post_1', photo:'/static/feed/1.jpg',
           ...
           items:[
             {category:'top',name:'White Ribbed Crop Top',color:'white',style_tags:['minimal','y2k'],price_estimate_usd:25,search_query:'white ribbed cropped sleeveless tank top women',image_url:'https://image.hm.com/assets/hm/59/12/591234ce7947b24f9bbb9ce0abf536e0d0551563.jpg'},
             {category:'bottoms',name:'Barrel-Leg Light Wash Denim',color:'light blue',style_tags:['denim','y2k'],price_estimate_usd:80,search_query:'barrel leg light wash jeans women',image_url:'https://n.nordstrommedia.com/it/15963ac9-5f3f-4207-b119-a021e1db52e7.jpeg?h=368&w=240&dpr=2'},
             {category:'shoes',name:'Adidas Samba OG White',color:'white',style_tags:['retro','sporty'],price_estimate_usd:120,search_query:'adidas samba og white black sneakers',image_url:'https://assets.adidas.com/images/w_1880,f_auto,q_auto/c68f09963c6e47dcad68ac010115a208_9366/Stan_Smith_Shoes_White_FX5500_01_standard.jpg'},
           ],
          ...
          {ts:now-2*86400000, id:'demo_post_2', photo:'/static/feed/2.jpg',
           ...
           items:[
             {category:'top',name:'Vintage Band Graphic Tee',color:'black',style_tags:['streetwear','vintage'],price_estimate_usd:35,search_query:'vintage black band graphic tee oversized',image_url:'https://images.urbndata.com/is/image/UrbanOutfitters/89759898_049_b?$xlarge$&fit=constrain&qlt=80&wid=614'},
             {category:'bottoms',name:'Baggy Cargo Pants Khaki',color:'khaki',style_tags:['streetwear','utility'],price_estimate_usd:90,search_query:'baggy cargo pants khaki women utility',image_url:'https://is4.revolveassets.com/images/p4/n/uv/RTAR-WJ45_V1.jpg'},
             {category:'shoes',name:'New Balance 550 White Cream',color:'white',style_tags:['retro','casual'],price_estimate_usd:110,search_query:'new balance 550 white cream sneakers',image_url:'https://assets.adidas.com/images/w_1880,f_auto,q_auto/7f58eea8063344908fafb96773b13a1e_9366/Superstar_Shoes_White_EG4958_01_standard.jpg'},
             {category:'bag',name:'Mini Crossbody Black Canvas',color:'black',style_tags:['streetwear','everyday'],price_estimate_usd:30,search_query:'mini black canvas crossbody bag streetwear',image_url:'https://shop.mango.com/assets/rcs/pics/static/T8/fotos/S/87046714_CU_B.jpg?ts=1714729382668'},
           ],
          ...
          {ts:now-86400000, id:'demo_post_3', photo:'/static/feed/100_1072.JPG',
           ...
           items:[
             {category:'outerwear',name:'Oversized Camel Blazer',color:'camel',style_tags:['preppy','minimal'],price_estimate_usd:150,search_query:'oversized camel blazer women wool',image_url:'https://static.zara.net/assets/public/9885/e922/a0be46659e56/661cb395b150/08769916400-p/08769916400-p.jpg'},
             {category:'bottoms',name:'Straight-Leg Black Trousers',color:'black',style_tags:['minimal','office'],price_estimate_usd:70,search_query:'straight leg black tailored trousers women',image_url:'https://n.nordstrommedia.com/it/742c046e-df5e-4844-95b4-61e1096c97ed.jpeg?crop=pad&pad_color=FFF&format=jpeg&trim=color&trimcolor=FFF&w=780&h=1196'},
             {category:'shoes',name:'Pointed-Toe Leather Mules',color:'black',style_tags:['elegant','minimal'],price_estimate_usd:60,search_query:'pointed toe black leather mules women',image_url:'https://cdn.shopify.com/s/files/1/0610/1440/9428/files/10MM18-VENICE-20118-CASTAN.jpg'},
           ],
  ...
  const MP_NEW_SEED = [
    {id:'n1', name:'Wide Leg Trousers', search_query:'zara wide leg black trousers fashion', category:'bottoms', size:'M', price:59, brand:'Zara', style_tags:['minimal','chic'], isNew:true, occasion:'work', arrived_days:3, image_url:'https://n.nordstrommedia.com/it/15963ac9-5f3f-4207-b119-a021e1db52e7.jpeg?h=368&w=240&dpr=2'},
    {id:'n2', name:'Linen Blazer', search_query:'hm premium linen blazer cream oversized', category:'outerwear', size:'S', price:79, brand:'H&M', style_tags:['chic','office'], isNew:true, occasion:'work', arrived_days:5, image_url:'https://n.nordstrommedia.com/it/742c046e-df5e-4844-95b4-61e1096c97ed.jpeg?crop=pad&pad_color=FFF&format=jpeg&trim=color&trimcolor=FFF&w=780&h=1196'},
    {id:'n3', name:'Satin Slip Dress', search_query:'asos satin slip midi dress green', category:'dress', size:'XS', price:45, brand:'ASOS', style_tags:['romantic','evening'], isNew:true, occasion:'evening', arrived_days:2, image_url:'https://n.nordstrommedia.com/it/20c4ecd0-45e4-4ed7-90c4-2fada40be8ea.jpeg?crop=pad&pad_color=FFF&format=jpeg&trim=color&trimcolor=FFF&w=780&h=1196'},
    {id:'n4', name:'Air Force 1', search_query:'nike air force 1 white sneakers', category:'shoes', size:'39', price:199, brand:'Nike', style_tags:['retro','casual'], isNew:true, occasion:'sport', arrived_days:1, image_url:'https://assets.adidas.com/images/w_1880,f_auto,q_auto/c68f09963c6e47dcad68ac010115a208_9366/Stan_Smith_Shoes_White_FX5500_01_standard.jpg'},
    {id:'n5', name:'Oversized Linen Shirt', search_query:'cos linen white shirt oversized minimal', category:'top', size:'M', price:65, brand:'COS', style_tags:['minimal','summer'], isNew:true, occasion:'casual', arrived_days:6, image_url:'https://image.hm.com/assets/hm/59/12/591234ce7947b24f9bbb9ce0abf536e0d0551563.jpg'},
    {id:'n6', name:'Leather Belt Bag', search_query:'mango leather belt bag brown crossbody', category:'bag', price:49, brand:'Mango', style_tags:['everyday','utility'], isNew:true, occasion:'casual', arrived_days:4, image_url:'https://shop.mango.com/assets/rcs/pics/static/T8/fotos/S/57049660_CU_B.jpg'},
    {id:'n7', name:'Ribbed Mini Skirt', search_query:'ribbed mini skirt beige y2k fashion', category:'dress', size:'S', price:35, brand:'ASOS', style_tags:['y2k','casual'], isNew:true, occasion:'casual', arrived_days:1, image_url:'https://is4.revolveassets.com/images/p4/n/tv/BENE-WD377_V1.jpg'},
    {id:'n8', name:'Cargo Utility Jacket', search_query:'cargo utility jacket green oversized streetwear', category:'outerwear', size:'L', price:89, brand:'H&M', style_tags:['streetwear','utility'], isNew:true, occasion:'casual', arrived_days:2, image_url:'https://n.nordstrommedia.com/it/742c046e-df5e-4844-95b4-61e1096c97ed.jpeg?crop=pad&pad_color=FFF&format=jpeg&trim=color&trimcolor=FFF&w=780&h=1196'},
  ];
      ...
      <div style="display:flex;flex-direction:column;gap:10px;padding:0 16px;max-height:320px;overflow-y:auto">
        ${suggestions.map(s => `
          <div style="background:var(--card);border-radius:14px;padding:12px 14px;border:1px solid var(--line)">
            ...
            <div style="font-size:var(--t-micro);color:var(--muted,#9e99ad);font-weight:600;margin-bottom:6px">${esc(s.reason)}</div>
            <div style="display:flex;gap:8px">
