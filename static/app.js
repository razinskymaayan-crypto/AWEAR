      ...
      if (!loadFeedPosts().length) {
        ...
        saveFeedPosts([
          {ts:now-4*86400000, id:'demo_post_1', photo:'/static/feed/1.jpg',
           ...
           items:[
             {category:'top',name:'White Ribbed Crop Top',color:'white',style_tags:['minimal','y2k'],price_estimate_usd:25,search_query:'white ribbed cropped sleeveless tank top women'},
             {category:'bottoms',name:'Barrel-Leg Light Wash Denim',color:'light blue',style_tags:['denim','y2k'],price_estimate_usd:80,search_query:'barrel leg light wash jeans women'},
             {category:'shoes',name:'Adidas Samba OG White',color:'white',style_tags:['retro','sporty'],price_estimate_usd:120,search_query:'adidas samba og white black sneakers'},
           ],
          ...
          {ts:now-2*86400000, id:'demo_post_2', photo:'/static/feed/2.jpg',
           ...
           items:[
             {category:'top',name:'Vintage Band Graphic Tee',color:'black',style_tags:['streetwear','vintage'],price_estimate_usd:35,search_query:'vintage black band graphic tee oversized'},
             {category:'bottoms',name:'Baggy Cargo Pants Khaki',color:'khaki',style_tags:['streetwear','utility'],price_estimate_usd:90,search_query:'baggy cargo pants khaki women utility'},
             {category:'shoes',name:'New Balance 550 White Cream',color:'white',style_tags:['retro','casual'],price_estimate_usd:110,search_query:'new balance 550 white cream sneakers'},
             {category:'bag',name:'Mini Crossbody Black Canvas',color:'black',style_tags:['streetwear','everyday'],price_estimate_usd:30,search_query:'mini black canvas crossbody bag streetwear'},
           ],
          ...
          {ts:now-86400000, id:'demo_post_3', photo:'/static/feed/100_1072.JPG',
           ...
           items:[
             {category:'outerwear',name:'Oversized Camel Blazer',color:'camel',style_tags:['preppy','minimal'],price_estimate_usd:150,search_query:'oversized camel blazer women wool'},
             {category:'bottoms',name:'Straight-Leg Black Trousers',color:'black',style_tags:['minimal','office'],price_estimate_usd:70,search_query:'straight leg black tailored trousers women'},
             {category:'shoes',name:'Pointed-Toe Leather Mules',color:'black',style_tags:['elegant','minimal'],price_estimate_usd:60,search_query:'pointed toe black leather mules women'},
           ],
