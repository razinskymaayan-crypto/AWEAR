...
# המוצר
Awear — אפליקציית אופנה ל-Gen-Z (משתמשת בת 17 בת"א, חיה על טיקטוק/אינסטגרם). 5 רבדים בסינרגיה: (1) ארון דיגיטלי = הפרופיל החברתי; (2) Shop the Look (affiliate); (3) מרקטפלייס יד-שנייה; (4) סטייליסט AI; (5) פיד חברתי בסטייל TikTok. תובנת-על: **הארון הוא הפרופיל ברשת** — בפרופיל של מישהי רואים את הבגדים עצמם (לא רק תמונות), עם "% התאמה לארון שלך".
